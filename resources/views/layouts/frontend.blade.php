...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="/" class="nav__logo "><img src="vendor\adminlte\dist\img\logo2.png" alt="" width="20%"
                    >TRAVELIN</a>
        ...
        <div class="footer__container container grid">
            <div>
                <a href="/" class="footer__logo">
                    <img src="vendor\adminlte\dist\img\logo2.png" alt="" style="width:100px">
                {{-- TRAVELIN --}}
                </a>
